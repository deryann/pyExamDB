    ...
    \begin{QUESTION}
        ...
        \begin{QBODY}
			...
			\begin{tikzpicture}[line width=1.5pt, scale=1.2]\small
\tikzstyle{vnode}=[draw, circle, inner sep=1pt,fill];
        % 繪製坐標軸
        \tikzstyle{axes}=[->,line width=2pt];
          \draw[axes] (-1,0) -- (4,0) node[right] {$x$};
          \draw[axes] (0,-1) -- (0,4) node[above] {$y$};
          \foreach \n/\x/\y/\a in{A/2.14/0/270, B/3.14/1/0, C/3.14/2.14/0, D/2.14/3.14/90,  
          E/1/3.14/90, F/0/2.14/180,  G/0/1/180,  H/1/0/270}{
                  \coordinate (v\n) at (\x,\y);
                  \node[vnode] (V\n) at (v\n) [label=\a:$\n$] {};}
        \draw[fill=gray!50!white] (vA) -- (vB) -- (vC) -- (vD) -- (vE) -- (vF) -- (vG) -- (vH) -- (vA);
\end{tikzpicture}
			\\
			\begin{QOPSINONELINE}
    ...
    \begin{QUESTION}
        ...
        \begin{QFROMS}
        \end{QFROMS}
        \begin{QTAGS}\QTAG{虛根定理}\QTAG{因式定理}\QTAG{餘式定理}\QTAG{B1C2多項式函數}\QTAG{B1C2-3多項式方程式}\QTAG{二次多項式}\QTAG{複數}\end{QTAGS}
        \begin{QANS}
            (1)(4)(5)
        \end{QANS}
        \begin{QSOLLIST}
    ...
    \begin{QUESTION}
        ...
        \begin{QFROMS}
        \end{QFROMS}
        \begin{QTAGS}\QTAG{B4C4-3雙曲線}\QTAG{B4C4二次曲線}\end{QTAGS}
        \begin{QANS}
            (1)(2)(4)(5)
        \end{QANS}
        \begin{QSOLLIST}
...
\node[label=270:$M$, draw, fill, inner sep=2pt, circle] (vM) at (0,0){}; 
\foreach \n/\a in {A/0, B/45, C/90, D/135, E/180} 
        {\node[label=\a:$\n$, draw, fill, inner sep=2pt, circle] (v\n) at (\a:2) {}; 
}
...
\end{tikzpicture}
    ...
    \begin{QUESTION}
        ...
        \begin{QFROMS}
        \end{QFROMS}
        \begin{QTAGS}\QTAG{B4C2-2空間直線方程式}\QTAG{B4C2空間中的平面與直線}\QTAG{距離}\end{QTAGS}
        \begin{QANS}
            $6 \sqrt{2} + 2\sqrt{6}$
        \end{QANS}
        \begin{QSOLLIST}
    ...
    \begin{QUESTION}
        ...
        \begin{QFROMS}
        \end{QFROMS}
        \begin{QTAGS}\QTAG{B3C3-1平面向量的表示法}\QTAG{B3C3平面向量}\QTAG{參數式}\end{QTAGS}
        \begin{QANS}
            $(9,1)$
        \end{QANS}
        \begin{QSOLLIST}
...
\begin{QSOL}
    ...
    \begin{QUESTION}
        ...
        \begin{QFROMS}
        \end{QFROMS}
        \begin{QTAGS}\QTAG{B2C1數列級數}\QTAG{B2C1-1數列}\QTAG{複利}\end{QTAGS}
        \begin{QANS}
            $8181$
        \end{QANS}
        \begin{QSOLLIST}
